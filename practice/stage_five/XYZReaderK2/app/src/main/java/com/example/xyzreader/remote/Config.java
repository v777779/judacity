...
// correction!!! hardcoded url
     ...
     *
     * @param rootView Context of calling activity
     ...
     */
    private static double getPercent( View rootView, int guideId) {
        return ((ConstraintLayout.LayoutParams)
                rootView.findViewById(guideId).getLayoutParams()).guidePercent;
    }
     ...
     */
    public static Span getDisplayMetrics(AppCompatActivity context, View rootView) {
        DisplayMetrics dp = new DisplayMetrics();
        context.getWindowManager().getDefaultDisplay().getMetrics(dp);
// tightened to layout
        double height_ratio = getPercent(rootView, R.id.guide_h2) - getPercent(rootView, R.id.guide_h1);
        double width_ratio = getPercent(rootView, R.id.guide_v2) - getPercent(rootView, R.id.guide_v1);
