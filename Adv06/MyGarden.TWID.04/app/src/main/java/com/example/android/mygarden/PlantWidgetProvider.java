...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (plantId == INVALID_PLANT_ID) {
            ...
            Log.d(TAG, context.getString(R.string.plant_id_log, Long.toString(plantId)));
        ...
        wateringIntent.putExtra(PlantWateringService.EXTRA_PLANT_ID, plantId); // внимание идет без проверки
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager,
                                          int imgRes, long plantId, boolean shawWater, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context, appWidgetManager,
                    imgRes, plantId, shawWater, appWidgetId);
        }
    }
