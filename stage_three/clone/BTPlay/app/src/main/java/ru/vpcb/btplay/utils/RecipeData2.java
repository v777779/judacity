...
public class RecipeData2 {
    ...
    public static Cursor query(final ContentResolver contentResolver, final LoaderManager loaderManager,
                                 final RecipeItem recipeItem, final LoaderDb mLoaderDb) {

        return null;

    }

    public static boolean delete(final ContentResolver contentResolver, final LoaderManager loaderManager,
                                 final RecipeItem recipeItem, final LoaderDb mLoaderDb) {
        DeleteRecord deleteRecord = new DeleteRecord(contentResolver, loaderManager, recipeItem, mLoaderDb);



        return deleteRecord.isDeleted();

    }

    public static boolean insert(final ContentResolver contentResolver, final LoaderManager loaderManager,
                                 final RecipeItem recipeItem, final LoaderDb mLoaderDb) {
        InsertRecord insertRecord = new InsertRecord(contentResolver, loaderManager, recipeItem, mLoaderDb);
        return insertRecord.isInserted();

    }


    public static boolean update(final ContentResolver contentResolver, final LoaderManager loaderManager,
                                 final RecipeItem recipeItem, final LoaderDb mLoaderDb) {
        UpdateRecord updateRecord = new UpdateRecord(contentResolver, loaderManager, recipeItem, mLoaderDb);
        return updateRecord.isUpdated();
    ...
    private static int bulkInsert(ContentResolver contentResolver, LoaderManager loaderManager,
    ...
    private static class DeleteRecord extends AsyncTask<Void, Void, Integer> {
        ...
        public DeleteRecord(ContentResolver resolver, LoaderManager manager, RecipeItem recipeItem, LoaderDb loader) {
        ...
        protected Integer doInBackground(Void... params) {
            return deleteRecord(mContentResolver, mLoaderManager, recipeItem, mLoaderDb);
        }
    ...
    private static class InsertRecord extends AsyncTask<Void, Void, Uri> {
        private final ContentResolver mContentResolver;
        private final LoaderManager mLoaderManager;
        private final RecipeItem recipeItem;
        private final LoaderDb mLoaderDb;
        ...
        public InsertRecord(ContentResolver resolver, LoaderManager manager, RecipeItem recipeItem, LoaderDb loader) {
            this.mContentResolver = resolver;
            this.mLoaderManager = manager;
            this.recipeItem = recipeItem;
            this.mLoaderDb = loader;
        ...
        protected Uri doInBackground(Void... params) {
            ...
            return insertRecord(mContentResolver, mLoaderManager, recipeItem, mLoaderDb);
        }
    ...
    private static class UpdateRecord extends AsyncTask<Void, Void, Integer> {
        private final ContentResolver mContentResolver;
        private final LoaderManager mLoaderManager;
        private final RecipeItem recipeItem;
        private final LoaderDb mLoaderDb;
        ...
        public UpdateRecord(ContentResolver resolver, LoaderManager manager, RecipeItem recipeItem, LoaderDb loader) {
            this.mContentResolver = resolver;
            this.mLoaderManager = manager;
            this.recipeItem = recipeItem;
            this.mLoaderDb = loader;
        ...
        protected Integer doInBackground(Void... params) {
            ...
            return updateRecord(mContentResolver, mLoaderManager, recipeItem, mLoaderDb);
        }
