...
public class EndpointIdling implements IdlingResource {
    ...
    @Override
    public synchronized void registerIdleTransitionCallback(ResourceCallback callback) {
        mCallback = callback;
    }
     ...
     */
    public synchronized void setIdleState(boolean isIdleNow) {
