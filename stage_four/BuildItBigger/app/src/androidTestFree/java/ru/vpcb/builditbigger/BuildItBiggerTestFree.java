...
import static ru.vpcb.constants.Constants.MESSAGE_TEST_FREE_OK;
...
public class BuildItBiggerTestFree {
    private static final String TAG = BuildItBiggerTestFree.class.getSimpleName();
    ...
    public void useAppContext() throws Exception {
        ...
        Log.i(TAG,MESSAGE_TEST_FREE_OK);
    }
}
