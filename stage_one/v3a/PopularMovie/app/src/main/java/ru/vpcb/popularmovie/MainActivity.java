...
//        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        ...
        MovieAdapter movieAdapter = new MovieAdapter(this, mListMovie, mSpan,
                new IClickListener<MovieItem>() {
                    @Override
                    public void onItemClick(MovieItem item) {               // callback realization
                        sendIntent(item);
                    }
                });   //context  and data
